...
//{
//   class CLASS_DECL_SUBSYSTEM_MACOS WindowsRegistryKey
//   {
//   public:
//      WindowsRegistryKey(HKEY rootKey, const ::scoped_string & scopedstrEntry, bool createIfNotExists = true, SECURITY_ATTRIBUTES *sa = 0);
//      WindowsRegistryKey(WindowsRegistryKey *rootKey, const ::scoped_string & scopedstrEntry, bool createIfNotExists = true, SECURITY_ATTRIBUTES *sa = 0);
//      WindowsRegistryKey(HKEY rootKey);
...
//      // Defer initialization. Can be used only when it has been
//      // created by the default constructor.
//      void open(WindowsRegistryKey *rootKey,
