...
namespace subsystem_macos
{
      ...
      {
         ::pointer < ::subsystem_macos::File > pfileFirstSideWrite;
         ::pointer < ::subsystem_macos::File > pfileFirstSideRead;
         ::pointer < ::subsystem_macos::File > pfileSecondSideWrite;
         ::pointer < ::subsystem_macos::File > pfileSecondSideRead;
