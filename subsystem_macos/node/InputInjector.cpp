...
namespace subsystem_macos
{
     ...
     //:
     {
      ...
      void InputInjector::injectKeyEvent(::user::enum_key euserkey, bool release, bool extended)
      {
         ...
         if (euserkey == ::user::e_key_control || euserkey == ::user::e_key_left_control || euserkey == ::user::e_key_left_control) {
            m_controlIsPressed = !release;
         }
         if (euserkey == ::user::e_key_alt || euserkey == ::user::e_key_left_alt || euserkey == ::user::e_key_right_alt) {
            m_menuIsPressed = !release;
         }
         if (euserkey == ::user::e_key_delete) {
            m_deleteIsPressed = !release;
         }
         if (euserkey == ::user::e_key_shift || euserkey == ::user::e_key_left_shift || euserkey == ::user::e_key_right_shift) {
...
//                keyEvent.ki.wVk = euserkey;
//                keyEvent.ki.wScan = MapVirtualKey(euserkey, 0);
//
//                if (release) {
