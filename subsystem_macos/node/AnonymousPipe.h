...
#include "subsystem_macos/node/Pipe.h"
...
namespace subsystem_macos
{
      ...
      class CLASS_DECL_SUBSYSTEM_MACOS AnonymousPipe :
      ...
      public:
         ...
         memsize available()  override{ return 0; };
      ...
      //private:
         ...
         ::pointer< ::subsystem_macos::File > m_pfileWrite;
         ::pointer< ::subsystem_macos::File > m_pfileRead;
