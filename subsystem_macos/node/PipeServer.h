...
//#include "subsystem_macos/node/::happening.h"
#include "acme/parallelization/happening.h"
//#include "subsystem/node/security/SecurityAttributes.h"
#include "subsystem/node/PipeServer.h"
#include "subsystem_macos/node/security/SecurityAttributes.h"
...
namespace subsystem_macos
{
    ...
    */
   class CLASS_DECL_SUBSYSTEM_MACOS PipeServer :
   ...
   public:
      ...
      //private:
      //static ::pointer < ::subsystem_macos::DynamicLibrary >  s_pdynamiclibraryKernel32;
       ...
       * @deprecated.
       */
      void waitForConnect(const class ::time & time = ::time::infinity());
      /**
       * @deprecated.
       */
