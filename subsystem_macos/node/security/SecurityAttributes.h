...
//#include "subsystem_macos/node/security/SecurityIdentifier.h"
//#include "subsystem_macos/node/security/SecurityDescriptor.h"
//
//
//namespace subsystem_macos
//{
//      class CLASS_DECL_SUBSYSTEM_MACOS SecurityAttributes :
