...
namespace subsystem_macos
{
   ...
   class CLASS_DECL_SUBSYSTEM_MACOS subsystem :
   ...
   public:
      ...
      // ::pointer < ::subsystem::Shell >     m_pshell;
       ...
       //::pointer<::subsystem_macos::WTS> m_pwts;
      ...
      //virtual ::subsystem_macos::WTS & WTS();
      virtual PipeServer * pipe_server();

             virtual void _parse_macos_command_line_arguments(::subsystem::CommandLineArguments *pcommandlinearguments,
