...
AXUIElementRef axuielement_menu_bar_item(AXUIElementRef axuielement, ::collection::index i)
{
...
AXUIElementRef axuielement_menu_bar_item_menu(AXUIElementRef axuielement, ::collection::index i)
{
...
AXUIElementRef axuielement_menu_bar_item_menu_item_with(AXUIElementRef axuielement, ::collection::index i, const char * psz)
{
...
::collection::count axuielement_application_window_count(AXUIElementRef axuielement)
{
