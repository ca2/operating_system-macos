...
- (id) initWithFrame: (NSRect) frame andAuraWindow: (AuraWindow *) papexwindow
{
...
- (void) mouseUp: (NSEvent *) event
{
   ...
   aura_window * p = m_papexwindow->m_papexwindow;
...
//  // {
//      
//      //      m_papexwindow->aura_window_on_become_first_responder();
//      
//    //  return YES;
//      
//  // }
