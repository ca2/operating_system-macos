...
namespace windows
{
   ...
   bool callstack::stack_first(CONTEXT * pcontext, int iCount)
   {
      ...
      m_stackframe.AddrFrame.Mode = AddrModeFlat;
#else
      m_stackframe.AddrPC.offset = (unsigned int)papplication->Fir;
      m_stackframe.AddrPC.Mode = AddrModeFlat;
      m_stackframe.AddrReturn.offset = (unsigned int)papplication->IntRa;
      m_stackframe.AddrReturn.Mode = AddrModeFlat;
      m_stackframe.AddrStack.offset = (unsigned int)papplication->IntSp;
      m_stackframe.AddrStack.Mode = AddrModeFlat;
      m_stackframe.AddrFrame.offset = (unsigned int)papplication->IntFp;
      m_stackframe.AddrFrame.Mode = AddrModeFlat;
#endif
