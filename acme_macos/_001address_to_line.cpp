...
#include "budemang.h"
   ...
   void
   address_to_line::usage (FILE *stream, int status)
   {
...
address_to_line::slurp_symtab (bfd *abfd)
   ...
   void
address_to_line::find_address_in_section (bfd *abfd, asection *section,
   ...
   void
address_to_line::find_offset_in_section (bfd *abfd, asection *section)
   {
      bfd_size_type size;
   ...
   void
address_to_line::translate_addresses (bfd *abfd, asection *section)
   {
   ...
   int
address_to_line::process_file (const char *file_name, const char *section_name,
                 const char *target)
   {
      bfd *abfd;
      asection *section;
   ...
   
   int
address_to_line::main (int argc, char **argv)
   {
