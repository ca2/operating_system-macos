...
//}
//
//inline int _001ClientToScreen(::oswindow window, POINT_I32 * ppoint)
...
//}
//
//inline int _001ScreenToClient(::oswindow window, POINT_I32 * ppoint)
