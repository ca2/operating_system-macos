...
::i32 __text_field::layout_width()
{
   
   if(m_iLayoutWidth <= 0)
   {
      
      __get_fitting_size(m_iLayoutWidth, m_iLayoutHeight);
      
   }
   
   return ::innate_ui::still::layout_width();
   
   
}

::i32 __text_field::layout_height()
{
   
   if(m_iLayoutHeight <= 0)
   {
   ...
   return ::innate_ui::still::layout_height();
   
   
}

   void __text_field::set_text(const ::scoped_string & scopedstr)
   {
...
void __text_field::set_font_size(::f64 dSizeEm)
{

   main_send([this, dSizeEm]
   ()
      {

      __set_font_size(dSizeEm);
      //::string str;
         //gtk_window_set_title(GTK_WINDOW(m_pgtkwidget), str);
...
void __text_field::set_font_weight(::i32 iFontWeight)
{

   main_send([this, iFontWeight]
   ()
      {

      __set_font_weight(iFontWeight);
      //::string str;
         //gtk_window_set_title(GTK_WINDOW(m_pgtkwidget), str);
...
//
   ...
   void __text_field::_create_child(window * pwindow)
   {
   ...
   void __text_field::create()
   {
      ...
      main_send([this]()
         ...
         innate_ui()->m_windowmap[m_pNSTextField] = this;
   ...
   void __text_field::create_child(::innate_ui::window * pwindow)
   {
   ...
   void __text_field::destroy_window()
   {
      ...
      innate_ui()->m_windowmap[m_pNSTextField].release();
   ...
   void __text_field::set_position(const ::i32_point & pointParam)
   {
...
//         }
   ...
   void __text_field::set_size(const ::i32_size & sizeParam)
   {
   ...
   void __text_field::adjust_for_client_size(const ::i32_size & sizeParam)
   {
   ...
   ::innate_ui_appkit::innate_ui * __text_field::innate_ui()
   {
   ...
   void __text_field::defer_show_system_menu(::user::mouse * pmouse)
   {
