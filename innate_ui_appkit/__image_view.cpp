...
void __image_view::set_icon(::innate_ui::icon * picon)
{
   ...
   ()
      ...
      //::cast < ::innate_ui_appkit::icon > pappkiticon = picon;
...
//   void __image_view::set_text(const ::scoped_string & scopedstr)
//   {
//
//      ::string str(scopedstr);
//      
...
//   }
//
//void __image_view::set_font_size(::f64 dSizeEm)
//{
//
//   main_post([this, dSizeEm]
//   ()
//      {
//
...
//}
//
//void __image_view::set_font_weight(::i32 iFontWeight)
//{
//
//   main_post([this, iFontWeight]
//   ()
//      {
//
...
//
   ...
   void __image_view::_create_child(window * pwindow)
   {
   ...
   void __image_view::create()
   {
      ...
      main_send([this]()
         ...
         innate_ui()->m_windowmap[m_pNSImageView] = this;
   ...
   void __image_view::create_child(::innate_ui::window * pwindow)
   {
   ...
   void __image_view::destroy_window()
   {
      ...
      innate_ui()->m_windowmap[m_pNSImageView].release();
   ...
   void __image_view::set_position(const ::i32_point & pointParam)
   {
...
//         }
   ...
   void __image_view::set_size(const ::i32_size & sizeParam)
   {
   ...
   void __image_view::adjust_for_client_size(const ::i32_size & sizeParam)
   {
   ...
   ::innate_ui_appkit::innate_ui * __image_view::innate_ui()
   {
   ...
   void __image_view::defer_show_system_menu(::user::mouse * pmouse)
   {
