...
::i32_bool file_system()->exists(const char * path1)
{
...
::i32_bool file_system()->put_contents(const char * path, const char * contents, memsize len)
{
...
////
////   FILE_NAME_INFO * pinfo = (FILE_NAME_INFO *)new unsigned char[MAX_PATH * 8];
////
...
////      size = needed + 1024;
////      pSysHandleInformation = (PSYSTEM_HANDLE_INFORMATION)new unsigned char[i32_size];
...
////
////   ::u32 dwsize = 300;
////   PDWORD pDwId = (PDWORD)new unsigned char[dwsize];
...
////      delete pDwId;
////      dwsize += 50;
////      pDwId = (PDWORD)new unsigned char[dwsize];
////   }
...
::i32_bool file_set_length(const char * lpszName, size_t iSize)
{
...
//
//
//::i32_bool file_exists_raw(const char * path1)
//{
//
//
