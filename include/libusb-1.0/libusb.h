 ...
 * \returns the value in little-endian unsigned char order
 */
 ...
 * \returns the value in host-endian unsigned char order
 */
 ...
 * All multiple-unsigned char fields are represented in host-endian format.
 */
 ...
 * the USB 3.0 specification. All multiple-unsigned char fields are represented in
 * host-endian format.
 */
 ...
 * All multiple-unsigned char fields, except UUIDs, are represented in host-endian format.
 */
 ...
 * \returns pointer to the first unsigned char of the data section
 */
 ...
 * be given in host-endian unsigned char order.
 *
