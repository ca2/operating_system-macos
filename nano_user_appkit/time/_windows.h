...
//    pmsg->message = (UINT) pmessage->m_atom.long_long;
...
// CLASS_DECL_ACME string read_resource_as_string(hinstance hinst, ::u32 nID, const char * pcszType, character_count iReadAtMostByteCount = -1);
