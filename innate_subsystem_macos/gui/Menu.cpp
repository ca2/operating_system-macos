...
//   bool Menu::_modifyMenu(unsigned int uPosition, unsigned int uFlags, ::uptr uIDNewItem, const char * lpNewItem)
//   {
//      //ASSERT(m_hmenu != 0);
//
...
//
//
      return true;//return !!DeleteMenu(m_hmenu, uPosition, MF_BYPOSITION);
   }
