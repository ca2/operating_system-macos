...
namespace innate_subsystem_windows
{
   ...
   bool Framebuffer::assignProperties(const ::innate_subsystem::Framebuffer &pframebufferSource)
   {
   ...
   bool Framebuffer::clone(const ::innate_subsystem::Framebuffer &pframebufferSource)
   {
   ...
   bool Framebuffer::isEqualTo(const ::innate_subsystem::PixelFormat &pframebuffer)
   {
