...
namespace innate_subsystem_macos
{
   ...
   class CLASS_DECL_INNATE_SUBSYSTEM_MACOS  DibSection :
   ...
   //private:
      ...
      virtual void _openDIBSection(const ::innate_subsystem::PixelFormat &pf, const ::i32_size &size,
...
//      void _setupBMIStruct(BITMAPINFO *pBmi, const ::innate_subsystem::PixelFormat & pf, const ::i32_size & dim);
       ...
       ::pointer < ::innate_subsystem_macos::DeviceContext > m_pdevicecontextTarget;
   ...
   // virtual public composite < DibSection
   // {
   // public:
   //    // Note that if the compatibleWin doesn't specify or is zero the class will create an
   //    // DC for the entire screen. In this case an this object owner must provide
